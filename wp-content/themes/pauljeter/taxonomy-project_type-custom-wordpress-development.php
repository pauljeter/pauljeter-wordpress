...
function custom_project_loop() {
    ...
    $args= array( 'project_type' => 'custom-wordpress-development' , 'posts_per_page' => 20 );
query_posts ($args);

?>
 
<h1 class="page-title">Portfolio: Custom WordPress Development</h1>
<h3 class="portfolio">My Custom WordPress Development Portfolio contains some of my latest Custom WordPress Development projects and project details. To hire me for a project, visit my freelance company: <a href="http://www.headturningmedia.com/#quote-form" target="_blank">Head Turning Media</a>. To hire me to be a part of your company's team, <a href="/resume" target="_self">View My Resume and Contact Me Today!</a></h3>
