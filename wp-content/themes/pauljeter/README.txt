<strong>pauljeter CHILD THEME</strong>
<a href="http://www.studiopress.com/themes/pauljeter">http://www.studiopress.com/themes/pauljeter</a>

<strong>INSTALL</strong>
1. Upload the pauljeter child theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the pauljeter theme.
...
Welcome - This is the welcome section of the homepage.
Featured - This is the featured section of the homepage.
Portfolio - This is the portfolio section of the homepage.
...
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the pauljeter child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the pauljeter child theme demo site.

featured - 500px by 250px
portfolio - 160px by 100px
