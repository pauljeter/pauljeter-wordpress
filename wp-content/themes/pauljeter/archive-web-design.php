...
add_action('genesis_loop', 'custom_portfolio_loop');
...
function custom_portfolio_loop() {
...
<h3 class="portfolio">My Design Portfolio contains some of my latest projects and project details. To hire me for a project, visit my freelance company: <a href="http://www.headturningmedia.com/#quote-form" target="_blank">Head Turning Media</a>. To hire me to be a part of your company's team, <a href="/contact-me/" target="_self">contact me today!</a></h3>
...
<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_post_thumbnail( array(600,200,true) ); ?></a>
