...
function custom_project_loop() {
    ...
    $args= array( 'project_type' => 'javascript-jquery-development' , 'posts_per_page' => 20 );
query_posts ($args);

?>
 
<h1 class="page-title">Portfolio: Ad Design</h1>
<h3 class="portfolio">My JavaScript/jQuery Portfolio contains some of my latest projects that include JavaScript/jQuery development and project details. To hire me for a project, visit my freelance company: <a href="http://www.headturningmedia.com/#quote-form" target="_blank">Head Turning Media</a>. To hire me to be a part of your company's team, <a href="/resume" target="_self">View My Resume and Contact Me Today!</a></h3>
